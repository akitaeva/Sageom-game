var puzzlePieces = [
    {name: '0', img: 'seedOfLife01.png', positionIndx: 0, rotationValue: 0},
    {name: '1', img: 'seedOfLife02.png', positionIndx: 1, rotationValue: 0},
    {name: '2', img: 'seedOfLife03.png', positionIndx: 2, rotationValue: 0}, 
    {name: '3', img: 'seedOfLife04.png', positionIndx: 3, rotationValue: 0}, 
    {name: '4', img: 'seedOfLife05.png', positionIndx: 4, rotationValue: 0}, 
    {name: '5', img: 'seedOfLife06.png', positionIndx: 5, rotationValue: 0}, 
    {name: '6', img: 'seedOfLife07.png', positionIndx: 6, rotationValue: 0}, 
    {name: '7', img: 'seedOfLife08.png', positionIndx: 7, rotationValue: 0}, 
    {name: '8', img: 'seedOfLife09.png', positionIndx: 8, rotationValue: 0}, 
...
var Sageom = function(array) {
        ...
        this.pieces.forEach(function(element, i){
            // 
            // console.log('this is a lement' + element,i);
            // html +=
            // $(element).data("positionIndex", i);
            // var that = this;
            // $(element).setAttribute("name", i);
            // console.log( 'after shuffle'+element);
        });
        ...
        var index = that.pieces.indexOf(pic);
          html += '<div class= "pieces" name ="' + pic.name + '" id="' + index + '"' ;
...
document.getElementById("start-button").onclick = function() {
    ...
    $('.pieces').on('click', function() {
        ...
        //     if (!result) {
        //         setTimeout(function() {
        //             //switch the position indexes of the elements
